...
#let cetz-perceptron() = {
  ...
  group({
    ...
    content((-0.28, 0), text(size: 10.5pt, weight: "bold", fill: hcs-navy)[$sum$])
    content((0.28, 0), text(size: 10.5pt, weight: "bold", fill: hcs-blue)[$sigma$])
    ...
    line((-1.75, -0.85), (-0.62, -0.1), stroke: 1.5pt + hcs-navy-light, mark: (end: ">", size: 0.13))
    content((-1.15, 0.65), text(size: 7.5pt, fill: hcs-navy, weight: "bold")[$w_1$])
    content((-1.15, -0.65), text(size: 7.5pt, fill: hcs-navy, weight: "bold")[$w_2$])
    ...
    content("x1", text(size: 7.5pt, weight: "bold", fill: hcs-navy-dark)[$x_1$])
    content("x2", text(size: 7.5pt, weight: "bold", fill: hcs-navy-dark)[$x_2$])

    // Output
    line("node.east", (1.5, 0), stroke: 1.5pt + hcs-navy, mark: (end: ">", size: 0.13))
    content((1.85, 0), text(size: 8.5pt, weight: "bold", fill: hcs-navy-dark)[$y$])

    // Math & label footer
    content((0, -1.28), text(size: 8pt, weight: "bold", fill: hcs-navy)[Ridge / Hyperplane])
    content((0, -1.58), text(size: 6.5pt, fill: hcs-text-muted)[$y = sigma(sum w_i x_i + b)$])
    content((0, -1.88), text(size: 5.5pt, fill: hcs-slate-dark)[dot product \u{2022} global half-spaces])
  })
}
...
#let cetz-kan() = {
  ...
  group({
    ...
    content((0, 0), text(size: 12pt, weight: "bold", fill: rgb("#047857"))[$sum$])
    ...
    content((-1.15, 0.85), box(
      fill: hcs-surface,
      inset: (x: 4.5pt, top: 2.5pt, bottom: 4.5pt),
      radius: 3pt,
      stroke: 0.8pt + rgb("#A7F3D0"),
      text(size: 7pt, weight: "bold", fill: rgb("#047857"))[$phi_1(x)$],
    ))
    content((-1.15, -0.85), box(
      fill: hcs-surface,
      inset: (x: 4.5pt, top: 2.5pt, bottom: 4.5pt),
      radius: 3pt,
      stroke: 0.8pt + rgb("#A7F3D0"),
      text(size: 7pt, weight: "bold", fill: rgb("#047857"))[$phi_2(x)$],
    ))

    // Output
    line("node.east", (1.5, 0), stroke: 1.5pt + rgb("#059669"), mark: (end: ">", size: 0.13))
    content((1.85, 0), text(size: 8.5pt, weight: "bold", fill: rgb("#047857"))[$y$])

    // Math & label footer
    content((0, -1.28), text(size: 8pt, weight: "bold", fill: rgb("#047857"))[1D Superposition])
    content((0, -1.58), text(size: 6.5pt, fill: hcs-text-muted)[$y = sum phi_i (x_i)$])
    content((0, -1.88), text(size: 5.5pt, fill: hcs-slate-dark)[1D splines \u{2022} coordinate curves])
  })
}
...
#let cetz-rbf() = {
  ...
  group({
    ...
    content((0, 0.1), text(size: 8.5pt, weight: "bold", fill: rgb("#B45309"))[$e^(-gamma d^2)$])
    content((0, -0.26), text(size: 6pt, fill: rgb("#D97706"))[center $bold(c)$])
    ...
    content((-1.18, 0.56), box(
      ...
      text(size: 6.2pt, weight: "bold", fill: rgb("#B45309"))[$|x_1 - c_1|$],
    ))
    content((-1.18, -0.56), box(
      fill: hcs-surface,
      inset: (x: 4.5pt, y: 4pt),
      radius: 3pt,
      stroke: 0.8pt + rgb("#FDE68A"),
      text(size: 6.2pt, weight: "bold", fill: rgb("#B45309"))[$|x_2 - c_2|$],
    ))

    // Output
    line("node.east", (1.5, 0), stroke: 1.5pt + rgb("#D97706"), mark: (end: ">", size: 0.13))
    content((1.85, 0), text(size: 8.5pt, weight: "bold", fill: rgb("#B45309"))[$y$])

    // Math & label footer
    content((0, -1.28), text(size: 8pt, weight: "bold", fill: rgb("#B45309"))[Metric / Kernel])
    content((0, -1.58), text(size: 6.5pt, fill: hcs-text-muted)[$y = exp(-gamma norm(bold(x) - bold(c))^2)$])
    content((0, -1.88), text(size: 5.5pt, fill: hcs-slate-dark)[euclidean metric \u{2022} hyperspheres])
  })
}
